CREATE TABLE shop2_43 (
    ...
    remote_img_url text,
    CONSTRAINT fk_1
    FOREIGN KEY (cat_id) REFERENCES category2_43(cid) on DELETE SET NULL on UPDATE CASCADE
);
...
INSERT INTO shop2_43 (pid, pname, cat_id, price,img_url, remote_img_url)
VALUES
(36,'Blue Tanktop','4',25,'/images/midterm/womens/blue-tank.png','https://i.ibb.co/7CQVJNm/blue-tank.png'),
(37,'Floral Blouse','4',20,'/images/midterm/womens/floral-blouse.png','https://i.ibb.co/4W2DGKm/floral-blouse.png'),
(38,'Floral Dress','4',80,'/images/midterm/womens/floral-skirt.png','https://i.ibb.co/KV18Ysr/floral-skirt.png'),
(39,'Red Dots Dress','4',80,'/images/midterm/womens/red-polka-dot-dress.png','https://i.ibb.co/N3BN1bh/red-polka-dot-dress.png'),
(40,'Stripped Sweater','4',45,'/images/midterm/womens/striped-sweater.png','https://i.ibb.co/KmSkMbH/striped-sweater.png"'),
(41,'Yellow Track Suite','4',135,'/images/midterm/womens/yellow-track-suit.png','https://i.ibb.co/v1cvwNf/yellow-track-suit.png'),
(42,'White Blouse','4',20,'/images/midterm/womens/white-vest.png','https://i.ibb.co/qBcrsJg/white-vest.png')